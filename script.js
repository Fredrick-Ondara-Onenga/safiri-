// === Improved Hero Background Code with Opacity Transition ===
...
function updateSlide() {
  ...
  overlay.style.backgroundImage = `url('${slides[next].image}')`;
  ...
  // After transition completes, update main background and clean up
  setTimeout(() => {
    // Update main background
    hero.style.backgroundImage = `url('${slides[next].image}')`;
    
    // Remove overlay
    hero.removeChild(overlay);
  ...
  }, 1500); // Match this with CSS transition duration (1.5s)
}
...
// Start the hero slider when page loads
